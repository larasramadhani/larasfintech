...
<body>
    ...
    justify-content-between">
            <div class="logo">
                <h1><a href="index.html">Koperasi sekolah</a> </h1> <!-- Uncomment below if
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">WELCOME TO KOPERASI</h1>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
                    <img src="assets/img/koprasi.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
